...
val isLSPBuiltIn get() = XposedInit.modulePath.contains("lspatch")
...
fun DocumentFile.findOrCreateFile(mimeType: String, displayName: String) =
    this.findFile(displayName) ?: this.createFile(mimeType, displayName)
